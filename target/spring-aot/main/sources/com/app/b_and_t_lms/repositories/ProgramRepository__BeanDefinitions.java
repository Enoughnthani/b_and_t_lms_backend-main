...
/**
 * Bean definitions for {@link ProgramRepository}.
 */
@Generated
public class ProgramRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'programRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getProgramRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'programRepository'.
   */
  public static BeanDefinition getProgramRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ProgramRepository.class, Program.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.app.b_and_t_lms.repositories.ProgramRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ProgramRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.app.b_and_t_lms.repositories.ProgramRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getProgramRepositoryInstanceSupplier();
