...
/**
 * Bean definitions for {@link UserOtpRepository}.
 */
@Generated
public class UserOtpRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'userOtpRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getUserOtpRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'userOtpRepository'.
   */
  public static BeanDefinition getUserOtpRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, UserOtpRepository.class, UserOtp.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.app.b_and_t_lms.repositories.UserOtpRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.UserOtpRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.app.b_and_t_lms.repositories.UserOtpRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getUserOtpRepositoryInstanceSupplier();
